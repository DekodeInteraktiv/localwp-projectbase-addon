...
const fixSslConfig = (siteId, sitePath, fileSystem, localLogger, context, shouldRestart = false) => __awaiter(void 0, void 0, void 0, function* () {
    if (!sitePath) {
        return undefined;
    }
...
function default_1(context) {
    ...
    hooks.addAction('siteStarted', (site) => __awaiter(this, void 0, void 0, function* () {
        yield fixSslConfig(site.id, site.path, fileSystem, localLogger, context, false);
    }));
